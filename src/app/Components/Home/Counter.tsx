    ...
    return (
        <div ref={ref} className="max-w-7xl w-full mx-auto p-5 grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-y-10">
            <motion.div 
                ...
                animate={controls1}
            >
                <Image src="/People_3.svg" alt="People" width={100} height={100} />
            ...
            <motion.div 
                ...
                animate={controls2}
            >
                <Image src="/File-Search.svg" alt="People" width={100} height={100} />
            ...
            <motion.div 
                ...
                animate={controls3}
            >
                <Image src="/User-Hexagon.svg" alt="People" width={100} height={100} />
            ...
            <motion.div 
                ...
                animate={controls4}
            >
                <Image src="/Smile.svg" alt="People" width={100} height={100} />
